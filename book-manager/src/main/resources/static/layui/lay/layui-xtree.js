...
layuiXtree.prototype.Loading = function (options) {
    ...
    if (typeof (options.children) == 'object') {
        _this._dataJson = options.children;
...
layuiXtree.prototype.dataBind = function (d) {
    ...
    if (obj != null ) {
        for (i in obj) {
            var xtree_isend = '';
            var xtree_ischecked = '';
            var xtree_isdisabled = obj[i].disabled ? ' disabled="disabled" ' : '';
            _this._domStr += '<div class="layui-xtree-item">';
            if (obj[i].children != null)
                ...
                xtree_ischecked = obj[i].checked ? ' checked ' : '';
                xtree_isdisabled = obj[i].disabled ? ' disabled="disabled" ' : '';
            }
